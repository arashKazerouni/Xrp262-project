      ...
      <header className="glass sticky top-0 z-50 border-x-0 border-t-0">
        <div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href={ASSET_URL} target="_blank" rel="noreferrer" className="rounded-full border border-slate-700 bg-slate-950/60 px-3 py-1.5 font-mono text-[9px] tracking-[0.12em] text-slate-300 transition hover:border-blue-500/50 hover:text-white">
              ASSET ↗
            </a>
          </div>
        </div>
